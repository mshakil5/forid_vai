                ...
                <div class="card card-secondary">
                    ...
                    <div class="card-body">
                        ...
                        <form id="createThisForm">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="short_description">Short Essay<span style="color: red;">*</span></label>
                                ...
                                <div class="form-group col-md-12">
                                    <label for="description">Long Essay<span style="color: red;">*</span></label>
...
<script>
  $(document).ready(function () {
      ...
      var url = "{{URL::to('/admin/international-publication')}}";
      var upurl = "{{URL::to('/admin/international-publication-update')}}";
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('change', '.toggle-status', function () {
            ...
            $.ajax({
                url: '{{ route('internationalPublicationToggleStatus') }}',
                method: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
                    id: itemId,
